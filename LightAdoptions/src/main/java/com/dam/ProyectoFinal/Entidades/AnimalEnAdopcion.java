...
public class AnimalEnAdopcion {
	...
	/*Esta variable se va a usar para gestionar el estado del animal(EN ADOPCION/EN ACOGIDA/ADOPTADO)*/
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "codigo_veterinario", nullable = false)
	private Veterinario veterinario;
	
	/*atributo relacional de relacion 1:1 con datos medicos*/
	@OneToOne
	@JoinColumn(name = "codigo_datos_medicos", nullable = false)
	...
	public AnimalEnAdopcion(@NotEmpty(message = "debe especificar la ciudad desde donde da en adopcion al animal") String ciudad,
			String datosAdicionales,
			@NotEmpty(message = "debe especificar el peso del animal") double peso,
			...
			@NotEmpty(message = "debe especificar el estado del animal") String estado,
			String historia,
			@NotEmpty(message = "debe especificar el tamaño del animal") String tamanyo,
			@NotEmpty(message = "debe añadir al menos una foto del animal") String imagenPrincipal,
			String imagenExtra1,
			String imagenExtra2,
			String imagenExtra3) {
	...
	public String toString() {
		return "AnimalEnAdopcion [codigo=" + codigo + ", ciudad=" + ciudad + ", datosAdicionales=" + datosAdicionales
				+ ", peso=" + peso + ", sexo=" + sexo + ", especie=" + especie + ", edad=" + edad
				+ ", personalidad=" + personalidad + ", requisitosAdopcion=" + requisitosAdopcion + ", nivelActividad="
				+ nivelActividad + ", estado=" + estado + ", historia=" + historia + ", tamanyo=" + tamanyo
				+ ", usuario=" + usuario + ", veterinario=" + veterinario + ", datosMedicos=" + datosMedicos + "]";
	}
